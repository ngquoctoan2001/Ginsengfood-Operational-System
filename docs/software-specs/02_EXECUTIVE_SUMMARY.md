...
| Sản xuất theo công thức versioned | G1 là baseline go-live; G2/G3/G4... phải được approve/activate/snapshot/audit/retire. |
...
| Recall sẵn sàng | Khi có sự cố, hệ thống xác định batch/lot/customer exposure, hold/sale lock, notification, recovery, disposition, CAPA. |
...
| Nhóm | Lock |
| --- | --- |
| Recipe | G1 là initial operational baseline; baseline nghiên cứu/lịch sử không dùng vận hành; hỗ trợ G2/G3/G4... |
...
| M13 | Recall | Incident, hold, sale lock, recall, recovery, disposition, CAPA. |
