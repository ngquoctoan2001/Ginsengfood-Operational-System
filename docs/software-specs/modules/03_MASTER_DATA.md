...
| M03-F02 | Supplier management | Quản lý nhà cung cấp nội bộ cho raw material/procurement. | P0 |
...
| `op_supplier` | master | Supplier reference. | M03 | Public trace must not expose internal supplier detail. |
