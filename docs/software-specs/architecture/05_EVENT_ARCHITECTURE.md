...
| `RECIPE_ACTIVATED`                 | M04      | M07, M15                | recipe_id, sku_id, formula_version, formula_kind, anchor_ingredient_id (PILOT)                                                                                           |
| `PRODUCTION_ORDER_OPENED`          | M07      | M08, M12, M15           | production_order_id, sku_id, recipe snapshot ref, snapshot_formula_version, formula_kind_snapshot, snapshot_basis, anchor_quantity_input (PILOT) hoặc batch_size (FIXED) |
...
| `RECALL_CLOSED_WITH_RESIDUAL_RISK` | M13      | M11, M12, M14, M15      | recall_case_id, residual_note, approver, closed_at, clean_capa_evidence_count                                                                                            |
