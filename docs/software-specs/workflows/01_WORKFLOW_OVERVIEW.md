...
| WF-04 | Recipe governance | M04 | R&D, QA Manager, Production Manager | SKU, ingredient, 4 recipe groups, effective date | Approved active recipe version | Must be approved, effective, active; snapshot must be immutable | API M04; UI SCR-RECIPE, SCR-RECIPE-LINES; TC-UI-REC-001 |
...
| WF-15 | Recall | M13 | QA Manager, Recall Manager | Incident or affected entity | Recall case, impact snapshot, hold/sale lock, recovery, CAPA | Cannot close with open recovery/CAPA; trace gaps flagged | API M13; UI SCR-RECALL-*; TC-UI-RCL-001 |
...
| Recall Manager | Impact analysis, hold/sale lock, recovery, CAPA. |
