...
| AP-CAPA-001 | CAPA close | Recall Manager | QA Manager | `CAPA` | `CAPA -> CLOSED` | Remain `CAPA` | `POST /api/admin/recall/cases/{id}/close` | SCR-RECALL-RECOVERY-CAPA | All recovery/disposition/CAPA done, evidence exists | `RECALL_CLOSED` | TC-UI-CAPA-001 |
