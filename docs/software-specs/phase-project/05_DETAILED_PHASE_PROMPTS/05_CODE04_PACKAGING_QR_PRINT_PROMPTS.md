...
Output: gap map, first gap, GTIN/printer blockers, progress update.
```
...
Output: DB/API/UI/seed/test plan, owner data needed, progress update.
```
...
Output: backend/API/UI/tests, progress update.
```
...
Output: DB/backend/API/UI/tests, progress update.
```
...
Output: lifecycle service/API/tests, state history evidence, progress update.
```
...
Output: print job/log changes, device assumptions, tests, progress update.
```
...
Output: verdict, validation, blockers, progress update.
```
