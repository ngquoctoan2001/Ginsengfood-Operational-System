...
|---|---|---|
| DATA-LOCK-001 | G1 là baseline operational đầu tiên | `g1_recipe_headers.csv.formula_version = G1` cho toàn bộ 20 SKU |
...
| Recipe header | `(sku_code, formula_version)` | một active G1 mỗi SKU |
