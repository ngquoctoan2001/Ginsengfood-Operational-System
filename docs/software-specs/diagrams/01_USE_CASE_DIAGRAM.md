...
| UC05 | M05 Source Origin | WF-M05-VERIFY | `/api/admin/source-zones`, `/api/admin/source-origins`, `/api/admin/source-origins/{id}/evidence` | SCR-SOURCE-ZONES, SCR-SOURCE-ORIGINS | `op_source_zone`, `op_source_origin`, `op_source_origin_evidence`, `op_source_origin_verification` |
...
| UC16 | M13 Recall | WF-M13-RECALL, WF-M13-HOLD | `/api/admin/incidents`, `/api/admin/recall/cases/*`, `/api/admin/recall/capas/{capaId}/evidence` | SCR-RECALL-* | `op_recall_case`, `op_recall_exposure_snapshot`, `op_batch_hold_registry`, `op_recall_capa`, `op_recall_capa_evidence` |
