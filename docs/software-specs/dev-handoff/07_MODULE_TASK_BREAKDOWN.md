...
| CODE12 | T-C12-M10-DEVICE | M10/M14/M15 | Printer/device boundary | device/print logs | printers/devices | Device console | device tests | No direct DB/device bypass |
| CODE13 | T-C13-M14-OUTBOX | M01/M14 | Event schema/outbox/MISA adapter | event/misa tables | events/misa | MISA monitor | TC-M14-* | Retry/reconcile pass |
...
| CODE16 | T-C16-M01-RETENTION | M01/M11/M12/M13/M14 | Retention/archive/restore | retention/archive | retention/archive | Archive admin | retention tests | Restore drill documented |
...
```text
CODE01 -> CODE02 -> MX-GATE-G1 -> CODE03 -> CODE04 -> CODE05 -> CODE06 -> CODE07 -> CODE08 -> CODE17
```
